...
class AdvertisersServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string relationshipStatus Filters out all
     *            advertisers for which do not have the given relationship
     *            status with the requesting publisher.
     *            @opt_param double minSevenDayEpc Filters out all advertisers
     *            that have a seven day EPC average lower than the given value
     *            (inclusive). Min value: 0.0. Optional.
     *            @opt_param string advertiserCategory Caret(^) delimted list of
     *            advertiser categories. Valid categories are defined here:
     ...
     *            categories. Optional.
     *            @opt_param double minNinetyDayEpc Filters out all advertisers
     *            that have a ninety day EPC average lower than the given value
     *            (inclusive). Min value: 0.0. Optional.
     *            @opt_param string pageToken The value of 'nextPageToken' from
     *            the previous page. Optional.
     *            @opt_param string maxResults Max number of items to return in
     *            this page. Optional. Defaults to 20.
     *            @opt_param int minPayoutRank A value between 1 and 4, where 1
     *            represents the quartile of advertisers with the lowest ranks
     *            and 4 represents the quartile of advertisers with the highest
     *            ranks. Filters out all advertisers with a lower rank than the
     *            given quartile. For example if a 2 was given only advertisers
     ...
     * advertiser/publisher has access
     * to it.
     * Only publishers can lookup advertisers. Advertisers can request
     * information about
     ...
     *            below.
     *
     *            @opt_param string advertiserId The ID of the advertiser to
     *            look up. Optional.
     * @return Advertiser
     */
...
class CcOffersServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string advertiser The advertiser ID of a card
     *            issuer whose offers to include. Optional, may be repeated.
...
class EventsServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string orderId Caret(^) delimited list of order
     *            IDs. Filters out all events that do not reference one of the
     *            given order IDs. Optional.
     *            @opt_param string sku Caret(^) delimited list of SKUs. Filters
     *            out all events that do not reference one of the given SKU.
     *            Optional.
     *            @opt_param string eventDateMax Filters out all events later
     *            than given date. Optional. Defaults to 24 hours after
     *            eventMin.
     *            @opt_param string type Filters out all events that are not of
     *            the given type. Valid values: 'action', 'transaction',
     *            'charge'. Optional.
     *            @opt_param string linkId Caret(^) delimited list of link IDs.
     *            Filters out all events that do not reference one of the given
     *            link IDs. Optional.
     *            @opt_param string status Filters out all events that do not
     *            have the given status. Valid values: 'active', 'canceled'.
     *            Optional.
     *            @opt_param string eventDateMin Filters out all events earlier
     *            than given date. Optional. Defaults to 24 hours from current
     *            date/time.
     *            @opt_param string memberId Caret(^) delimited list of member
     *            IDs. Filters out all events that do not reference one of the
     *            given member IDs. Optional.
     *            @opt_param string maxResults Max number of offers to return in
     *            this page. Optional. Defaults to 20.
     *            @opt_param string advertiserId Caret(^) delimited list of
     *            advertiser IDs. Filters out all events that do not reference
     *            one of the given advertiser IDs. Only used when under
     *            publishers role. Optional.
     *            @opt_param string pageToken The value of 'nextPageToken' from
     *            the previous page. Optional.
     *            @opt_param string productCategory Caret(^) delimited list of
     *            product categories. Filters out all events that do not
     *            reference a product in one of the given product categories.
     *            Optional.
     *            @opt_param string chargeType Filters out all charge events
     *            that are not of the given charge type. Valid values: 'other',
     *            'slotting_fee', 'monthly_minimum', 'tier_bonus', 'credit',
     *            'debit'. Optional.
     *            @opt_param string publisherId Caret(^) delimited list of
     *            publisher IDs. Filters out all events that do not reference
     *            one of the given publishers IDs. Only used when under
...
class PublishersServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string publisherCategory Caret(^) delimted list of
     *            publisher categories. Valid categories:
     ...
     *            categories. Optional.
     *            @opt_param string relationshipStatus Filters out all
     *            publishers for which do not have the given relationship status
     *            with the requesting publisher.
     *            @opt_param double minSevenDayEpc Filters out all publishers
     *            that have a seven day EPC average lower than the given value
     *            (inclusive). Min value 0.0. Optional.
     *            @opt_param double minNinetyDayEpc Filters out all publishers
     *            that have a ninety day EPC average lower than the given value
     *            (inclusive). Min value: 0.0. Optional.
     *            @opt_param string pageToken The value of 'nextPageToken' from
     *            the previous page. Optional.
     ...
     *            this page. Optional. Defaults to 20.
     *            @opt_param int minPayoutRank A value between 1 and 4, where 1
     *            represents the quartile of publishers with the lowest ranks
     *            and 4 represents the quartile of publishers with the highest
     *            ranks. Filters out all publishers with a lower rank than the
     *            given quartile. For example if a 2 was given only publishers
     *            with a payout rank of 25 or higher would be included.
     *            Optional.
     * @return Publishers
     */
     ...
     * advertiser/publisher has access
     * to it.
     * Only advertisers can look up publishers. Publishers can request
     * information about
     ...
     *            below.
     *
     *            @opt_param string publisherId The ID of the publisher to look
     *            up. Optional.
     * @return Publisher
     */
    public function get ($role, $roleId, $optParams = array())
 ...
 * <a href="https://code.google.com/apis/gan/" target="_blank">API
 * Documentation</a>
 * </p>
 *
 * @author Google, Inc.
...
class CcOffer extends apiModel
{
    ...
    public function setIntroBalanceTransferAprDisplay (
            $introBalanceTransferAprDisplay)
    {
    ...
    public function setIntroBalanceTransferPeriodUnits (
            $introBalanceTransferPeriodUnits)
    {
    ...
    public function setVariableRatesUpdateFrequency (
    ...
    public function setIntroBalanceTransferPeriodLength (
            $introBalanceTransferPeriodLength)
    {
    ...
    public function setInitialSetupAndProcessingFee (
    ...
    public function setCashAdvanceAdditionalDetails (
            $cashAdvanceAdditionalDetails)
    {
    ...
    public function setForeignCurrencyTransactionFee (
    ...
    public function setIntroBalanceTransferFeeAmount (
            $introBalanceTransferFeeAmount)
    {
    ...
    public function setIntroBalanceTransferRateType (
            $introBalanceTransferRateType)
    {
    ...
    public function setIntroBalanceTransferPeriodEndDate (
            $introBalanceTransferPeriodEndDate)
    {
