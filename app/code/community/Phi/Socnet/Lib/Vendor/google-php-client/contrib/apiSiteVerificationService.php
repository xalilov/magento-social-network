...
class WebResourceServiceResource extends apiServiceResource
{
     ...
     */
    public function insert ($verificationMethod,
            SiteVerificationWebResourceResource $postBody, $optParams = array())
    {
        $params = array('verificationMethod' => $verificationMethod,
                'postBody' => $postBody);
     ...
     *            below.
     *
     *            @opt_param string verificationMethod The method to use for
     *            verifying a site or domain.
     *            @opt_param string identifier The URL or domain to verify.
     *            @opt_param string type Type of resource to verify. Can be
     *            'site' (URL) or 'inet_domain' (domain name).
 ...
 * <a href="http://code.google.com/apis/siteverification/" target="_blank">API
 * Documentation</a>
 * </p>
 *
 * @author Google, Inc.
...
class SiteVerificationWebResourceListResponse extends apiModel
{
    ...
    {
        $this->assertIsArray($items, 'SiteVerificationWebResourceResource',
                __METHOD__);
        $this->items = $items;
    }
