...
/**
 * Wrapper for the (experimental!) JSON-RPC protocol, for production use regular
 * REST calls instead
 *
...
class apiBatch
{
    ...
    /**
     * Execute one or multiple Google API requests, takes one or multiple
     * requests as param
     * Example usage:
     * $ret = apiBatch::execute(
     * $apiClient->activities->list(array('@public', '@me'),
     * 'listActivitiesKey'),
