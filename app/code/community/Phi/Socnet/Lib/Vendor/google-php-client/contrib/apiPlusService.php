...
class PeopleServiceResource extends apiServiceResource
{
     ...
     * @return PeopleFeed
     */
    public function listByActivity ($activityId, $collection,
    $optParams = array())
    {
        $params = array('activityId' => $activityId,
 ...
 * <a href="http://developers.google.com/+/api/" target="_blank">API
 * Documentation</a>
 * </p>
 *
 * @author Google, Inc.
...
class ActivityObject extends apiModel
{
    ...
    {
        $this->assertIsArray($attachments, 'ActivityObjectAttachments',
                __METHOD__);
