...
/**
 * Internal representation of a Google API request, used by the
 * apiServiceResource class to
 * construct API function calls and passing them to the IO layer who knows how
 * to execute
 * the request
 *
...
class apiServiceRequest
{
     ...
     */
    public function __construct ($restBasePath, $rpcPath, $restPath, $rpcName,
            $httpMethod, $parameters, $postBody = null)
    {
