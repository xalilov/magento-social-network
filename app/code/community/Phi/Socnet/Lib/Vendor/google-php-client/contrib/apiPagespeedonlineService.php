...
class PagespeedapiServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string locale The locale used to localize formatted
     *            results
     *            @opt_param string rule A Page Speed rule to run; if none are
 ...
 * <a
 * href="https://code.google.com/apis/pagespeedonline/v1/getting_started.html"
...
class Result extends apiModel
{
    ...
    public function setFormattedResults (
...
class ResultFormattedResults extends apiModel
{
    ...
    public function setRuleResults (
...
class ResultFormattedResultsRuleResults extends apiModel
{
    ...
    {
        $this->assertIsArray($urlBlocks,
                'ResultFormattedResultsRuleResultsUrlBlocks', __METHOD__);
...
class ResultFormattedResultsRuleResultsUrlBlocks extends apiModel
{
    ...
    public function setUrls(/* array(ResultFormattedResultsRuleResultsUrlBlocksUrls) */ $urls)
    {
        $this->assertIsArray($urls,
                'ResultFormattedResultsRuleResultsUrlBlocksUrls', __METHOD__);
        $this->urls = $urls;
    }
...
class ResultFormattedResultsRuleResultsUrlBlocksHeader extends apiModel
{
    ...
    public function setArgs(/* array(ResultFormattedResultsRuleResultsUrlBlocksHeaderArgs) */ $args)
    {
        $this->assertIsArray($args,
                'ResultFormattedResultsRuleResultsUrlBlocksHeaderArgs',
                __METHOD__);
        $this->args = $args;
    }
...
class ResultFormattedResultsRuleResultsUrlBlocksUrlsDetails extends apiModel
{
    ...
    {
        $this->assertIsArray($args,
                'ResultFormattedResultsRuleResultsUrlBlocksUrlsDetailsArgs',
                __METHOD__);
        $this->args = $args;
    }
...
class ResultFormattedResultsRuleResultsUrlBlocksUrlsResult extends apiModel
{
    ...
    {
        $this->assertIsArray($args,
                'ResultFormattedResultsRuleResultsUrlBlocksUrlsResultArgs',
                __METHOD__);
        $this->args = $args;
    }
