...
class ManagementWebpropertiesServiceResource extends apiServiceResource
{
     ...
     *            Account ID for the web properties to retrieve. Can either be a
     *            specific account ID or '~all', which refers to all the
     *            accounts to which user has access.
     ...
     */
    public function listManagementWebproperties ($accountId,
            $optParams = array())
    {
...
class ManagementGoalsServiceResource extends apiServiceResource
{
     ...
     *            Web property ID for the web properties to retrieve. Can either
     *            be a specific web property ID or '~all', which refers to all
     *            the web properties to which the user has access.
     * @param string $profileId
     *            Profile ID for the web properties to retrieve. Can either be a
     *            specific profile ID or '~all', which refers to all the
     ...
     * @return Goals
     */
    public function listManagementGoals ($accountId, $webPropertyId, $profileId,
    $optParams = array())
    {
        $params = array('accountId' => $accountId,
...
class ManagementProfilesServiceResource extends apiServiceResource
{
     ...
     * @return Profiles
     */
    public function listManagementProfiles ($accountId, $webPropertyId,
    $optParams = array())
    {
        $params = array('accountId' => $accountId,
...
class DataGaServiceResource extends apiServiceResource
{
     ...
     *
     * @param string $ids
     *            Unique table ID for retrieving Analytics data. Table ID is of
     *            the form ga:XXXX, where XXXX is the Analytics profile ID.
     * @param string $start_date
     *            Start date for fetching Analytics data. All requests should
     *            specify a start date formatted as YYYY-MM-DD.
     * @param string $end_date
     *            End date for fetching Analytics data. All requests should
     *            specify an end date formatted as YYYY-MM-DD.
     * @param string $metrics
     *            A comma-separated list of Analytics metrics. E.g.,
     *            'ga:visits,ga:pageviews'. At least one metric must be
     *            specified.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     ...
     *            @opt_param string sort A comma-separated list of dimensions or
     *            metrics that determine the sort order for Analytics data.
     *            @opt_param string dimensions A comma-separated list of
     *            Analytics dimensions. E.g., 'ga:browser,ga:city'.
     *            @opt_param int start-index An index of the first entity to
     *            retrieve. Use this parameter as a pagination mechanism along
     *            with the max-results parameter.
     *            @opt_param string segment An Analytics advanced segment to be
     *            applied to data.
     *            @opt_param string filters A comma-separated list of dimension
     *            or metric filters to be applied to Analytics data.
     * @return GaData
     */
    public function get ($ids, $start_date, $end_date, $metrics,
    $optParams = array())
    {
        $params = array('ids' => $ids, 'start-date' => $start_date,
                'end-date' => $end_date, 'metrics' => $metrics);
        $params = array_merge($params, $optParams);
...
class apiAnalyticsService extends apiService
{
    ...
    public function __construct (apiClient $apiClient)
    {
        ...
        $this->management_webproperties = new ManagementWebpropertiesServiceResource(
        ...
        $this->management_segments = new ManagementSegmentsServiceResource($this,
                ...
                json_decode(
                        ...
                        true));
        $this->management_accounts = new ManagementAccountsServiceResource($this,
                ...
                json_decode(
                        ...
                        true));
        $this->management_goals = new ManagementGoalsServiceResource($this,
                ...
                json_decode(
                        ...
                        true));
        $this->management_profiles = new ManagementProfilesServiceResource($this,
                ...
                json_decode(
                        ...
                        true));
        $this->data_ga = new DataGaServiceResource($this, $this->serviceName,
                'ga',
                json_decode(
...
class Profile extends apiModel
{
    ...
    public function setSiteSearchCategoryParameters (
