...
class PostsServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string pageToken Continuation token if the request
     *            is paged.
     *            @opt_param bool fetchBodies Whether the body content of posts
     *            is included.
...
class PagesServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param bool fetchBodies Whether to retrieve the Page
     *            bodies.
     * @return PageList
     */
...
class CommentsServiceResource extends apiServiceResource
{
     ...
     *            @opt_param string maxResults Maximum number of comments to
     *            include in the result.
     *            @opt_param string pageToken Continuation token if request is
     *            paged.
     *            @opt_param bool fetchBodies Whether the body content of the
...
class UsersBlogsServiceResource extends apiServiceResource
{
     ...
     *
     * @param string $userId
     *            ID of the user whose blogs are to be fetched.
     * @return BlogList
     */
 ...
 * <a
 * href="https://code.google.com/apis/blogger/docs/2.0/json/getting_started.html"
...
class apiBloggerService extends apiService
{
    ...
    public function __construct (apiClient $apiClient)
    {
        ...
        $this->blogs = new BlogsServiceResource($this, $this->serviceName,
                'blogs',
                json_decode(
                        '{"methods": {"get": {"scopes": ["https://www.googleapis.com/auth/blogger"], "parameters": {"blogId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.blogs.get", "httpMethod": "GET", "path": "blogs/{blogId}", "response": {"$ref": "Blog"}}}}',
                        true));
        $this->posts = new PostsServiceResource($this, $this->serviceName,
                'posts',
                json_decode(
                        ...
                        true));
        $this->pages = new PagesServiceResource($this, $this->serviceName,
                'pages',
                json_decode(
        ...
        $this->comments = new CommentsServiceResource($this, $this->serviceName,
                ...
                json_decode(
                        ...
                        true));
        $this->users = new UsersServiceResource($this, $this->serviceName,
                'users',
                json_decode(
                        '{"methods": {"get": {"scopes": ["https://www.googleapis.com/auth/blogger"], "parameters": {"userId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.users.get", "httpMethod": "GET", "path": "users/{userId}", "response": {"$ref": "User"}}}}',
                        true));
        $this->users_blogs = new UsersBlogsServiceResource($this,
                $this->serviceName, 'blogs',
                json_decode(
                        '{"methods": {"list": {"scopes": ["https://www.googleapis.com/auth/blogger"], "parameters": {"userId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.users.blogs.list", "httpMethod": "GET", "path": "users/{userId}/blogs", "response": {"$ref": "BlogList"}}}}',
                        true));
    }
}
