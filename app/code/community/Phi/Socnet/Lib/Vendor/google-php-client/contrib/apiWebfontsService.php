...
class WebfontsServiceResource extends apiServiceResource
{
    ...
    /**
     * Retrieves the list of fonts currently served by the Google Web Fonts
     * Developer API
     * (webfonts.list)
     *
 ...
 * <a href="http://code.google.com/apis/webfonts/docs/developer_api.html"
...
class apiWebfontsService extends apiService
{
    ...
    public function __construct (apiClient $apiClient)
    {
        ...
        $this->webfonts = new WebfontsServiceResource($this, $this->serviceName,
                'webfonts',
                json_decode(
                        '{"methods": {"list": {"parameters": {"sort": {"enum": ["alpha", "date", "popularity", "style", "trending"], "type": "string", "location": "query"}}, "id": "webfonts.webfonts.list", "httpMethod": "GET", "path": "webfonts", "response": {"$ref": "WebfontList"}}}}',
                        true));
    }
}
