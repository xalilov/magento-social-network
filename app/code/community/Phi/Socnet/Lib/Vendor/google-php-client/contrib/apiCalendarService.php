...
class CalendarListServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string pageToken Token specifying which result page
     *            to return. Optional.
     *            @opt_param bool showHidden Whether to show hidden entries.
     *            Optional. The default is False.
     *            @opt_param int maxResults Maximum number of entries returned
     *            on one result page. Optional.
     *            @opt_param string minAccessRole The minimum access role for
     *            the user in the returned entires. Optional. The default is no
     *            restriction.
     * @return CalendarList
     */
...
class CalendarsServiceResource extends apiServiceResource
{
     ...
     * This operation deletes all data associated with the primary calendar
...
class EventsServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param bool sendNotifications Whether to send
     *            notifications about the event update. Optional. The default is
     *            False.
     * @return Event
     */
     ...
     *
     *            @opt_param bool sendNotifications Whether to send
     *            notifications about the creation of the new event. Optional.
     ...
     *            below.
     *
     *            @opt_param string timeZone Time zone used in the response.
     *            Optional. The default is the time zone of the calendar.
     *            @opt_param int maxAttendees The maximum number of attendees to
     *            include in the response. If there are more than the specified
     ...
     *
     * @param string $calendarId
     *            Calendar identifier of the source calendar where the event
     *            currently is on.
     * @param string $eventId
     *            Event identifier.
     * @param string $destination
     *            Calendar identifier of the target calendar where the event is
     *            to be moved to.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     *
     *            @opt_param bool sendNotifications Whether to send
     *            notifications about the change of the event's organizer.
     *            Optional. The default is False.
     * @return Event
     */
    public function move ($calendarId, $eventId, $destination,
            $optParams = array())
    {
        $params = array('calendarId' => $calendarId, 'eventId' => $eventId,
     ...
     *            below.
     *
     *            @opt_param string orderBy The order of the events returned in
     *            the result. Optional. The default is an unspecified, stable
     *            order.
     *            @opt_param bool showHiddenInvitations Whether to include
     *            hidden invitations in the result. Optional. The default is
     *            False.
     *            @opt_param bool showDeleted Whether to include deleted events
     *            (with 'eventStatus' equals 'cancelled') in the result.
     *            Optional. The default is False.
     *            @opt_param string iCalUID Specifies iCalendar UID (iCalUID) of
     *            events to be included in the response. Optional.
     *            @opt_param string updatedMin Lower bound for an event's last
     *            modification time (as a RFC 3339 timestamp) to filter by.
     *            Optional. The default is not to filter by last modification
     *            time.
     *            @opt_param bool singleEvents Whether to expand recurring
     *            events into instances and only return single one-off events
     *            and instances of recurring events, but not the underlying
     *            recurring events themselves. Optional. The default is False.
     *            @opt_param int maxResults Maximum number of events returned on
     *            one result page. Optional.
     *            @opt_param string q Free text search terms to find events that
     *            match these terms in any field, except for extended
     *            properties. Optional.
     *            @opt_param string pageToken Token specifying which result page
     *            to return. Optional.
     *            @opt_param string timeMin Lower bound (inclusive) for an
     *            event's end time to filter by. Optional. The default is not to
     *            filter by end time.
     *            @opt_param string timeZone Time zone used in the response.
     *            Optional. The default is the time zone of the calendar.
     *            @opt_param string timeMax Upper bound (exclusive) for an
     *            event's start time to filter by. Optional. The default is not
     ...
     *
     *            @opt_param bool sendNotifications Whether to send
     *            notifications about the event update (e.g. attendee's
     *            responses, title changes, etc.). Optional. The default is
     *            False.
     * @return Event
     */
    public function update ($calendarId, $eventId, Event $postBody,
            $optParams = array())
    {
        $params = array('calendarId' => $calendarId, 'eventId' => $eventId,
                'postBody' => $postBody);
     ...
     * @return Event
     */
    public function patch ($calendarId, $eventId, Event $postBody,
            $optParams = array())
    {
        $params = array('calendarId' => $calendarId, 'eventId' => $eventId,
                'postBody' => $postBody);
     ...
     *            @opt_param string timeZone Time zone used in the response.
     *            Optional. The default is the time zone of the calendar.
     *            @opt_param string originalStart The original start time of the
     ...
     *
     *            @opt_param bool sendNotifications Whether to send
     *            notifications about the creation of the event. Optional. The
     *            default is False.
     * @return Event
     */
     ...
     *
     *            @opt_param bool sendNotifications Whether to send
     *            notifications about the deletion of the event. Optional. The
     *            default is False.
     */
 ...
 * <a href="http://code.google.com/apis/calendar/v3/using.html"
...
class apiCalendarService extends apiService
{
    ...
    public function __construct (apiClient $apiClient)
    {
        ...
        $this->freebusy = new FreebusyServiceResource($this, $this->serviceName,
                'freebusy',
                json_decode(
...
class Event extends apiModel
{
    ...
    public function setExtendedProperties (
