...
class BookshelvesServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string country ISO-3166-1 code to override the
     *            IP-based location.
     *            @opt_param string source String to identify the originator of
     *            this request.
     * @return Bookshelves
     */
...
class BookshelvesVolumesServiceResource extends apiServiceResource
{
     ...
     *            @opt_param string country ISO-3166-1 code to override the
     *            IP-based location.
     *            @opt_param bool showPreorders Set to true to show pre-ordered
     *            books. Defaults to false.
     *            @opt_param string maxResults Maximum number of results to
     *            return
     *            @opt_param string source String to identify the originator of
     *            this request.
     *            @opt_param string startIndex Index of the first element to
     *            return (starts at 0)
     * @return Volumes
     */
    public function listBookshelvesVolumes ($userId, $shelf,
    $optParams = array())
    {
        $params = array('userId' => $userId, 'shelf' => $shelf);
        $params = array_merge($params, $optParams);
...
class MyconfigServiceResource extends apiServiceResource
{
     ...
     *            The device/version identifier from which to release the
     *            restriction.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     *
     *            @opt_param string locale ISO-639-1, ISO-3166-1 codes for
     *            message localization, i.e. en_US.
     *            @opt_param string country ISO-3166-1 code to override the
     *            IP-based location.
     *            @opt_param string source String to identify the originator of
     *            this request.
     ...
     */
    public function releaseDownloadAccess ($volumeIds, $cpksver,
            $optParams = array())
    {
     ...
     * @param string $cpksver
     *            The device/version identifier from which to request the
     *            restrictions.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     ...
     */
    public function requestAccess ($source, $volumeId, $nonce, $cpksver,
    $optParams = array())
    {
        $params = array('source' => $source, 'volumeId' => $volumeId,
                'nonce' => $nonce, 'cpksver' => $cpksver);
        $params = array_merge($params, $optParams);
     ...
     *            @opt_param string country ISO-3166-1 code to override the
     *            IP-based location.
     *            @opt_param string volumeIds The volume(s) to request download
     *            restrictions for.
     * @return Volumes
     */
    public function syncVolumeLicenses ($source, $nonce, $cpksver,
    $optParams = array())
    {
        $params = array('source' => $source, 'nonce' => $nonce,
                'cpksver' => $cpksver);
        $params = array_merge($params, $optParams);
...
class VolumesServiceResource extends apiServiceResource
{
     ...
     *            @opt_param string projection Restrict information returned to
     *            a set of selected fields.
     *            @opt_param string libraryRestrict Restrict search to this
     *            user's library.
     *            @opt_param string langRestrict Restrict results to books with
     *            this language code.
     *            @opt_param string country ISO-3166-1 code to override the
     *            IP-based location.
     ...
     *            @opt_param string source String to identify the originator of
     *            this request.
     *            @opt_param string startIndex Index of the first result to
     *            return (starts at 0)
     *            @opt_param string download Restrict to volumes by download
     *            availability.
     *            @opt_param string partner Identifier of partner for whom to
     *            restrict and brand results.
     *            @opt_param bool showPreorders Set to true to show books
...
class MylibraryBookshelvesVolumesServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string shelf The bookshelf id or name retrieve
     *            volumes for.
     *            @opt_param string projection Restrict information returned to
     *            a set of selected fields.
     *            @opt_param string country ISO-3166-1 code to override the
     ...
     *            @opt_param string maxResults Maximum number of results to
     *            return
     *            @opt_param string q Full-text search query string in this
     *            bookshelf.
     *            @opt_param string source String to identify the originator of
     *            this request.
     *            @opt_param string startIndex Index of the first element to
...
class MylibraryAnnotationsServiceResource extends apiServiceResource
{
     ...
     *            The annotation identifier for the annotation to retrieve.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     *
     ...
     *            @opt_param string country ISO-3166-1 code to override the
     *            IP-based location.
     *            @opt_param string volumeId The volume to restrict annotations
     *            to.
     *            @opt_param string maxResults Maximum number of results to
     *            return
     *            @opt_param string pageToken The value of the nextToken from
     *            the previous page.
     *            @opt_param string pageIds The page id(s) for the volume that
     *            is being queried.
     *            @opt_param string contentVersion The content version for the
     *            requested volume.
     ...
     *
     * @param string $annotationId
     *            The annotation identifier for the annotation to update.
     * @param Annotation $postBody
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     ...
     * @return Annotation
     */
    public function update ($annotationId, Annotation $postBody,
            $optParams = array())
    {
        $params = array('annotationId' => $annotationId,
                'postBody' => $postBody);
     ...
     *
     * @param string $annotationId
     *            The annotation identifier for the annotation to delete.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     *
 ...
 * <a href="https://code.google.com/apis/books/docs/v1/getting_started.html"
...
class Annotation extends apiModel
{
    ...
    public function setCurrentVersionRanges (
    ...
    public function setClientVersionRanges (
...
class DownloadAccesses extends apiModel
{
    ...
    {
        $this->assertIsArray($downloadAccessList, 'DownloadAccessRestriction',
                __METHOD__);
...
class RequestAccess extends apiModel
{
    ...
    public function setConcurrentAccess (
...
class VolumeVolumeInfo extends apiModel
{
    ...
    {
        $this->assertIsArray($industryIdentifiers,
                'VolumeVolumeInfoIndustryIdentifiers', __METHOD__);
