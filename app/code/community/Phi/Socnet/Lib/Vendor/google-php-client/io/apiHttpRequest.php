...
class apiHttpRequest
{
    ...
    public function __construct ($url, $method = 'GET', $headers = array(), $postBody = null)
    {
        ...
        if (empty($apiConfig['application_name'])) {
            ...
            $this->userAgent = $apiConfig['application_name'] . " " .
    ...
    /**
     * Misc function that returns an array of the query parameters of
     * the
     * current
     ...
     *
     * @param string $key
     * @return array boolean the requested HTTP header or
    ...
    /**
     * Returns a cache key depending on if this was an OAuth signed
     * request
     * in which case it will use the non-signed url and access key to
     * make this
     * cache key unique per authenticated user, else use the plain
     * request url
     *
