...
class TablesServiceResource extends apiServiceResource
{
     ...
     * it only returns the table resource, which describes the structure of this
     * table. (tables.get)
     *
     ...
     * @return Table
     */
    public function patch ($projectId, $datasetId, $tableId, Table $postBody,
            $optParams = array())
    {
        $params = array('projectId' => $projectId, 'datasetId' => $datasetId,
                'tableId' => $tableId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
     ...
     */
    public function delete ($projectId, $datasetId, $tableId,
            $optParams = array())
    {
        $params = array('projectId' => $projectId, 'datasetId' => $datasetId,
                'tableId' => $tableId);
...
class DatasetsServiceResource extends apiServiceResource
{
     ...
     * read access; however, a
     * project owner can list (but not necessarily get) all datasets in his
     * project.
     * (datasets.list)
     *
     * @param string $projectId
     ...
     *            @opt_param string pageToken Page token, returned by a previous
     *            call, to request the next page of results
     *            @opt_param string maxResults The maximum number of results to
     *            return
     * @return DatasetList
     */
     ...
     * Properties not included in
     * the submitted resource will not be changed. If you include the access
     * property without any values
     * assigned, the request will fail as you must specify at least one owner
     * for a dataset.
     * (datasets.update)
     *
     * @param Dataset $postBody
     ...
     *            below.
     *
     *            @opt_param string projectId Project ID of the dataset being
     *            updated
     *            @opt_param string datasetId Dataset ID of the dataset being
     *            updated
     * @return Dataset
     */
     ...
     * @return Dataset
     */
    public function patch ($projectId, $datasetId, Dataset $postBody,
            $optParams = array())
    {
        $params = array('projectId' => $projectId, 'datasetId' => $datasetId,
                'postBody' => $postBody);
     ...
     * Before you can delete a dataset, you must
     * delete all its tables, either manually or by specifying deleteContents.
     * Immediately after
     ...
     *            below.
     *
     *            @opt_param bool deleteContents If True, delete all the tables
...
class JobsServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string projectId Project ID of the project that
     *            will be billed for the job
     * @return Job
     */
    ...
    /**
     * Lists all the Jobs in the specified project that were started by the
     * user.
     * (jobs.list)
     *
     * @param string $projectId
     ...
     *            @opt_param bool allUsers Whether to display jobs owned by all
     ...
     */
    public function query ($projectId, QueryRequest $postBody,
            $optParams = array())
    {
     ...
     *            below.
     *
     *            @opt_param string timeoutMs How long to wait for the query to
     *            complete, in milliseconds, before returning. Default is to
     *            return immediately. If the timeout passes before the job
     *            completes, the request will fail with a TIMEOUT error
     *            @opt_param string startIndex Zero-based index of the starting
     *            row
     ...
     *
     * @param string $projectId
     *            Project ID of the job to delete
     * @param string $jobId
...
class TabledataServiceResource extends apiServiceResource
{
     ...
     */
    public function listTabledata ($projectId, $datasetId, $tableId,
            $optParams = array())
    {
        $params = array('projectId' => $projectId, 'datasetId' => $datasetId,
                'tableId' => $tableId);
 ...
 * <a href="https://code.google.com/apis/bigquery/docs/v2/" target="_blank">API
 * Documentation</a>
 * </p>
 *
 * @author Google, Inc.
