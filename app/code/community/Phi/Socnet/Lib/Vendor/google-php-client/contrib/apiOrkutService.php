...
class CommunityMembersServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string hl Specifies the interface language (host
     ...
     *            below.
     *
     *            @opt_param string pageToken A continuation token that allows
     *            pagination.
     *            @opt_param bool friendsOnly Whether to list only community
     *            members who are friends of the user.
     *            @opt_param string maxResults The maximum number of members to
...
class ActivitiesServiceResource extends apiServiceResource
{
     ...
     *
     * @param string $userId
     *            The ID of the user whose activities will be listed. Can be me
     *            to refer to the viewer (i.e. the authenticated user).
...
class CommunityPollCommentsServiceResource extends apiServiceResource
{
     ...
     */
    public function insert ($communityId, $pollId,
            CommunityPollComment $postBody, $optParams = array())
    {
     ...
     * (communityPollComments.list)
     *
     * @param int $communityId
     *            The ID of the community whose poll is having its comments
     *            listed.
     * @param string $pollId
     ...
     */
    public function listCommunityPollComments ($communityId, $pollId,
            $optParams = array())
    {
        $params = array('communityId' => $communityId, 'pollId' => $pollId);
        $params = array_merge($params, $optParams);
...
class CommunityPollsServiceResource extends apiServiceResource
{
     ...
     *            @opt_param string pageToken A continuation token that allows
     *            pagination.
     *            @opt_param string maxResults The maximum number of polls to
     *            include in the response.
     *            @opt_param string hl Specifies the interface language (host
     *            language) of your user interface.
...
class CommunityMessagesServiceResource extends apiServiceResource
{
     ...
     */
    public function insert ($communityId, $topicId, CommunityMessage $postBody,
            $optParams = array())
    {
     ...
     *            @opt_param string pageToken A continuation token that allows
     *            pagination.
     *            @opt_param string maxResults The maximum number of messages to
     *            include in the response.
     *            @opt_param string hl Specifies the interface language (host
     *            language) of your user interface.
     * @return CommunityMessageList
     */
    public function listCommunityMessages ($communityId, $topicId,
            $optParams = array())
    {
        $params = array('communityId' => $communityId, 'topicId' => $topicId);
        $params = array_merge($params, $optParams);
     ...
     *
     * @param int $communityId
     *            The ID of the community whose message will be moved to the
     *            trash folder.
     * @param string $topicId
     *            The ID of the topic whose message will be moved to the trash
     *            folder.
     * @param string $messageId
     *            The ID of the message to be moved to the trash folder.
     */
    public function delete ($communityId, $topicId, $messageId,
            $optParams = array())
    {
        $params = array('communityId' => $communityId, 'topicId' => $topicId,
                'messageId' => $messageId);
...
class CommunityTopicsServiceResource extends apiServiceResource
{
     ...
     */
    public function insert ($communityId, CommunityTopic $postBody,
            $optParams = array())
    {
     ...
     *            @opt_param string pageToken A continuation token that allows
     *            pagination.
     *            @opt_param string maxResults The maximum number of topics to
     *            include in the response.
     *            @opt_param string hl Specifies the interface language (host
     *            language) of your user interface.
     ...
     * (communityTopics.delete)
     *
     * @param int $communityId
     *            The ID of the community whose topic will be moved to the trash
     *            folder.
     * @param string $topicId
...
class CommunityRelatedServiceResource extends apiServiceResource
{
     ...
     * (communityRelated.list)
     *
     * @param int $communityId
     *            The ID of the community whose related communities will be
     *            listed.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
...
class CommunityPollVotesServiceResource extends apiServiceResource
{
     ...
     */
    public function insert ($communityId, $pollId, CommunityPollVote $postBody,
            $optParams = array())
    {
        $params = array('communityId' => $communityId, 'pollId' => $pollId,
                'postBody' => $postBody);
...
class CommunitiesServiceResource extends apiServiceResource
{
     ...
     *
     * @param string $userId
     *            The ID of the user whose communities will be listed. Can be me
     *            to refer to caller.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     ...
     *            @opt_param string maxResults The maximum number of communities
     *            to include in the response.
     *            @opt_param string hl Specifies the interface language (host
     *            language) of your user interface.
     * @return CommunityList
...
class BadgesServiceResource extends apiServiceResource
{
     ...
     *
     * @param string $userId
     *            The id of the user whose badges will be listed. Can be me to
     *            refer to caller.
     * @return BadgeList
     */
...
class CountersServiceResource extends apiServiceResource
{
     ...
     *
     * @param string $userId
     *            The ID of the user whose counters will be listed. Can be me to
     *            refer to caller.
     * @return Counters
     */
 ...
 * <a href="http://code.google.com/apis/orkut/v2/reference.html"
...
class apiOrkutService extends apiService
{
    ...
    public function __construct (apiClient $apiClient)
    {
        ...
        $this->communityMembers = new CommunityMembersServiceResource($this,
                $this->serviceName, 'communityMembers',
                json_decode(
...
class CommunityMembers extends apiModel
{
    ...
    public function setCommunityMembershipStatus (
...
class CommunityPoll extends apiModel
{
    ...
    public function setIsVotingAllowedForNonMembers (
    ...
    {
        $this->assertIsArray($options, 'OrkutCommunitypolloptionResource',
                __METHOD__);
