...
class CseServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string sort The sort expression to apply to the
     *            results
     *            @opt_param string num Number of search results to return
     *            @opt_param string googlehost The local Google domain to use to
     *            perform the search.
     *            @opt_param string safe Search safety level
     *            @opt_param string filter Controls turning on or off the
     *            duplicate content filter.
     *            @opt_param string start The index of the first result to
     *            return
     *            @opt_param string cx The custom search engine ID to scope this
     *            search query
     *            @opt_param string lr The language restriction for the search
     *            results
     *            @opt_param string cr Country restrict(s).
     *            @opt_param string gl Geolocation of end user.
     *            @opt_param string cref The URL of a linked custom search
     *            engine
     * @return Search
     */
 ...
 * <a href="http://code.google.com/apis/customsearch/v1/using_rest.html"
