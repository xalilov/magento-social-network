...
class CurrentLocationServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string granularity Granularity of the requested
     *            location.
     * @return Location
     */
...
class LocationServiceResource extends apiServiceResource
{
     ...
     *            Timestamp of the location to read (ms since epoch).
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     *
     *            @opt_param string granularity Granularity of the location to
     *            return.
     * @return Location
     */
     ...
     *            below.
     *
     *            @opt_param string max-results Maximum number of locations to
     *            return.
     *            @opt_param string max-time Maximum timestamp of locations to
     *            return (ms since epoch).
     *            @opt_param string min-time Minimum timestamp of locations to
     *            return (ms since epoch).
     *            @opt_param string granularity Granularity of the requested
     *            locations.
     * @return LocationFeed
     ...
     *
     * @param string $locationId
     *            Timestamp of the location to delete (ms since epoch).
     */
 ...
 * <a href="http://code.google.com/apis/latitude/v1/using_rest.html"
...
class apiLatitudeService extends apiService
{
    ...
    public function __construct (apiClient $apiClient)
    {
        ...
        $this->currentLocation = new CurrentLocationServiceResource($this,
                $this->serviceName, 'currentLocation',
                json_decode(
