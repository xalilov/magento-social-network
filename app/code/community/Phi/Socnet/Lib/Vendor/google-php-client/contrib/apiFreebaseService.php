...
class TextServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string maxlength The max number of characters to
     *            return. Valid only for 'plain' format.
...
class MqlreadServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string lang The language of the results - an id of
     *            a /type/lang object.
     *            @opt_param bool html_escape Whether or not to escape entities.
     *            @opt_param string indent How many spaces to indent the json.
     *            @opt_param string uniqueness_failure How MQL responds to
     *            uniqueness failures.
     *            @opt_param string dateline The dateline that you get in a
     *            mqlwrite response to ensure consistent results.
     ...
     *            @opt_param string as_of_time Run the query as it would've been
     *            run at the specified point in time.
     */
...
class ImageServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string maxwidth Maximum width in pixels for
     *            resulting image.
     *            @opt_param string maxheight Maximum height in pixels for
     *            resulting image.
     *            @opt_param string fallbackid Use the image associated with
     *            this secondary id if no image is associated with the primary
     *            id.
     *            @opt_param bool pad A boolean specifying whether the resulting
     *            image should be padded up to the requested dimensions.
 ...
 * <a href="http://wiki.freebase.com/wiki/New_Freebase_API" target="_blank">API
 * Documentation</a>
 * </p>
 *
 * @author Google, Inc.
