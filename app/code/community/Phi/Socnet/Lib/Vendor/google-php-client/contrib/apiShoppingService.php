...
class ProductsServiceResource extends apiServiceResource
{
     ...
     *            @opt_param bool facets.enabled Whether to return facet
     *            information
     *            @opt_param bool relatedQueries.useGcsConfig This parameter is
     *            currently ignored
     *            @opt_param bool promotions.enabled Whether to return promotion
     *            information
     *            @opt_param bool debug.enabled Google Internal
     *            @opt_param string facets.include Facets to include (applies
     *            when useGcsConfig == false)
     ...
     *            @opt_param string startIndex Index (1-based) of first product
     *            to return
     ...
     *            @opt_param bool spelling.enabled Whether to return spelling
     *            suggestions
     *            @opt_param string taxonomy Taxonomy name
     *            @opt_param bool debug.geocodeRequest Google Internal
     *            @opt_param bool spelling.useGcsConfig This parameter is
     *            currently ignored
     *            @opt_param string useCase One of CommerceSearchUseCase,
     *            ShoppingApiUseCase
     *            @opt_param string location Location used to determine tax and
     *            shipping
     *            @opt_param string maxVariants Maximum number of variant
     *            results to return per result
     ...
     *            @opt_param bool redirects.useGcsConfig Whether to return
     *            redirect information as configured in the GCS account
     *            @opt_param bool safe Whether safe search is enabled. Default:
     *            true
     *            @opt_param bool categories.useGcsConfig This parameter is
     *            currently ignored
     *            @opt_param string maxResults Maximum number of results to
     *            return
     *            @opt_param bool facets.useGcsConfig Whether to return facet
     *            information as configured in the GCS account
     *            @opt_param bool categories.enabled Whether to return category
     *            information
     *            @opt_param string attributeFilter Comma separated list of
     *            attributes to return
     *            @opt_param bool sayt.enabled Google Internal
     *            @opt_param bool promotions.useGcsConfig Whether to return
     *            promotion information as configured in the GCS account
     ...
     *            @opt_param bool redirects.enabled Whether to return redirect
     *            information
     *            @opt_param bool debug.searchRequest Google Internal
     *            @opt_param bool relatedQueries.enabled Whether to return
     *            related queries
     ...
     *
     *            @opt_param string categories.include Category specification
     *            @opt_param bool recommendations.enabled Whether to return
     ...
     *            @opt_param bool debug.searchResponse Google Internal
     *            @opt_param bool debug.enabled Google Internal
     *            @opt_param string recommendations.include Recommendation
     *            specification
     *            @opt_param bool categories.enabled Whether to return category
     *            information
     *            @opt_param string productFields Google Internal
     ...
     *            @opt_param string attributeFilter Comma separated list of
     *            attributes to return
     *            @opt_param bool recommendations.useGcsConfig This parameter is
     *            currently ignored
     *            @opt_param string plusOne +1 rendering specification.
     *            @opt_param string thumbnails Thumbnail specification
     * @return Product
     */
    public function get ($source, $accountId, $productIdType, $productId,
    $optParams = array())
    {
        $params = array('source' => $source, 'accountId' => $accountId,
                'productIdType' => $productIdType, 'productId' => $productId);
        $params = array_merge($params, $optParams);
 ...
 * <a href="http://code.google.com/apis/shopping/search/v1/getting_started.html"
...
class Product extends apiModel
{
    ...
    {
        $this->assertIsArray($recommendations, 'ProductRecommendations',
                __METHOD__);
    ...
    {
        $this->assertIsArray($categories, 'ShoppingModelCategoryJsonV1',
                __METHOD__);
...
class ProductRecommendations extends apiModel
{
    ...
    {
        $this->assertIsArray($recommendationList,
                'ProductRecommendationsRecommendationList', __METHOD__);
...
class Products extends apiModel
{
    ...
    {
        $this->assertIsArray($shelfSpaceAds, 'ProductsShelfSpaceAds',
                __METHOD__);
...
class ProductsPromotions extends apiModel
{
    ...
    {
        $this->assertIsArray($customFields, 'ProductsPromotionsCustomFields',
                __METHOD__);
...
class ShoppingModelDebugJsonV1 extends apiModel
{
    ...
    {
        $this->assertIsArray($backendTimes,
                'ShoppingModelDebugJsonV1BackendTimes', __METHOD__);
...
class ShoppingModelProductJsonV1 extends apiModel
{
    ...
    {
        $this->assertIsArray($images, 'ShoppingModelProductJsonV1Images',
                __METHOD__);
        $this->images = $images;
    }
    ...
    {
        $this->assertIsArray($inventories,
                'ShoppingModelProductJsonV1Inventories', __METHOD__);
    ...
    {
        $this->assertIsArray($internal4, 'ShoppingModelProductJsonV1Internal4',
                __METHOD__);
    ...
    public function setAttributes(/* array(ShoppingModelProductJsonV1Attributes) */ $attributes)
    {
        $this->assertIsArray($attributes,
                'ShoppingModelProductJsonV1Attributes', __METHOD__);
    ...
    {
        $this->assertIsArray($variants, 'ShoppingModelProductJsonV1Variants',
                __METHOD__);
...
class ShoppingModelProductJsonV1Images extends apiModel
{
    ...
    public function setThumbnails(/* array(ShoppingModelProductJsonV1ImagesThumbnails) */ $thumbnails)
    {
        $this->assertIsArray($thumbnails,
                'ShoppingModelProductJsonV1ImagesThumbnails', __METHOD__);
