...
class UrlchannelsServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param string pageToken A continuation token, used to page
     *            through URL channels. To retrieve the next page, set this
     *            parameter to the value of "nextPageToken" from the previous
     *            response.
     *            @opt_param int maxResults The maximum number of URL channels
...
class AdunitsServiceResource extends apiServiceResource
{
     ...
     *            below.
     *
     *            @opt_param bool includeInactive Whether to include inactive ad
     *            units. Default: true.
     *            @opt_param string pageToken A continuation token, used to page
     *            through ad units. To retrieve the next page, set this
     *            parameter to the value of "nextPageToken" from the previous
     *            response.
     *            @opt_param int maxResults The maximum number of ad units to
...
class AdunitsCustomchannelsServiceResource extends apiServiceResource
{
     ...
     *            parameter to the value of "nextPageToken" from the previous
     *            response.
     *            @opt_param int maxResults The maximum number of custom
     *            channels to include in the response, used for paging.
     * @return CustomChannels
     */
    public function listAdunitsCustomchannels ($adClientId, $adUnitId,
            $optParams = array())
    {
        $params = array('adClientId' => $adClientId, 'adUnitId' => $adUnitId);
        $params = array_merge($params, $optParams);
...
class AdclientsServiceResource extends apiServiceResource
{
     ...
     *
     *            @opt_param string pageToken A continuation token, used to page
     *            through ad clients. To retrieve the next page, set this
     *            parameter to the value of "nextPageToken" from the previous
     *            response.
     *            @opt_param int maxResults The maximum number of ad clients to
     *            include in the response, used for paging.
     * @return AdClients
     */
...
class ReportsServiceResource extends apiServiceResource
{
     ...
     * parameters.
     * Returns the
     * result as JSON; to retrieve output in CSV format specify "alt=csv" as a
     * query parameter.
     * (reports.generate)
     *
     ...
     *            End of the date range to report on in "YYYY-MM-DD" format,
     *            inclusive.
     * @param array $optParams
     *            Optional parameters. Valid optional parameters are listed
     *            below.
     *
     *            @opt_param string sort The name of a dimension or metric to
     *            sort the resulting report on, optionally prefixed with "+" to
     *            sort ascending or "-" to sort descending. If no prefix is
     *            specified, the column is sorted ascending.
     *            @opt_param string locale Optional locale to use for
     *            translating report output to a local language. Defaults to
     *            "en_US" if not specified.
     *            @opt_param string metric Numeric columns to include in the
     *            report.
     *            @opt_param int maxResults The maximum number of rows of report
     *            data to return.
     *            @opt_param string filter Filters to be run on the report.
     *            @opt_param string currency Optional currency to use when
     *            reporting on monetary metrics. Defaults to the account's
     *            currency if not set.
     *            @opt_param int startIndex Index of the first row of report
     *            data to return.
...
class AccountsServiceResource extends apiServiceResource
{
     ...
     *
     *            @opt_param string pageToken A continuation token, used to page
     *            through accounts. To retrieve the next page, set this
     *            parameter to the value of "nextPageToken" from the previous
     *            response.
     *            @opt_param int maxResults The maximum number of accounts to
     *            include in the response, used for paging.
     * @return Accounts
     */
     ...
     *            below.
     *
     *            @opt_param bool tree Whether the tree of sub accounts should
     *            be returned.
     * @return Account
     */
...
class AccountsAdunitsServiceResource extends apiServiceResource
{
     ...
     * @return AdUnits
     */
    public function listAccountsAdunits ($accountId, $adClientId,
    $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId);
        $params = array_merge($params, $optParams);
     ...
     * @return AdUnit
     */
    public function get ($accountId, $adClientId, $adUnitId,
            $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId,
                'adUnitId' => $adUnitId);
...
class AccountsAdunitsCustomchannelsServiceResource extends apiServiceResource
{
     ...
     * @return CustomChannels
     */
    public function listAccountsAdunitsCustomchannels ($accountId, $adClientId,
    $adUnitId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId,
                'adUnitId' => $adUnitId);
        $params = array_merge($params, $optParams);
...
class AccountsCustomchannelsServiceResource extends apiServiceResource
{
     ...
     * @return CustomChannels
     */
    public function listAccountsCustomchannels ($accountId, $adClientId,
            $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId);
        $params = array_merge($params, $optParams);
     ...
     */
    public function get ($accountId, $adClientId, $customChannelId,
            $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId,
...
class AccountsCustomchannelsAdunitsServiceResource extends apiServiceResource
{
     ...
     * @return AdUnits
     */
    public function listAccountsCustomchannelsAdunits ($accountId, $adClientId,
    $customChannelId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId,
                'customChannelId' => $customChannelId);
        $params = array_merge($params, $optParams);
...
class CustomchannelsAdunitsServiceResource extends apiServiceResource
{
     ...
     * @return AdUnits
     */
    public function listCustomchannelsAdunits ($adClientId, $customChannelId,
    $optParams = array())
    {
        $params = array('adClientId' => $adClientId,
                'customChannelId' => $customChannelId);
 ...
 * <a href="https://code.google.com/apis/adsense/management/"
...
class apiAdsenseService extends apiService
{
    ...
    public function __construct (apiClient $apiClient)
    {
        ...
        $this->urlchannels = new UrlchannelsServiceResource($this,
                $this->serviceName, 'urlchannels',
                json_decode(
                        '{"methods": {"list": {"scopes": ["https://www.googleapis.com/auth/adsense", "https://www.googleapis.com/auth/adsense.readonly"], "parameters": {"pageToken": {"type": "string", "location": "query"}, "adClientId": {"required": true, "type": "string", "location": "path"}, "maxResults": {"format": "int32", "maximum": "10000", "minimum": "0", "location": "query", "type": "integer"}}, "id": "adsense.urlchannels.list", "httpMethod": "GET", "path": "adclients/{adClientId}/urlchannels", "response": {"$ref": "UrlChannels"}}}}',
                        true));
        $this->adunits = new AdunitsServiceResource($this, $this->serviceName,
                'adunits',
                json_decode(
                        ...
                        true));
        $this->adunits_customchannels = new AdunitsCustomchannelsServiceResource(
        ...
        $this->accounts_urlchannels = new AccountsUrlchannelsServiceResource(
                $this, $this->serviceName, 'urlchannels',
                json_decode(
                        ...
                        true));
        $this->accounts_adunits = new AccountsAdunitsServiceResource($this,
        ...
        $this->accounts_adunits_customchannels = new AccountsAdunitsCustomchannelsServiceResource(
                ...
                json_decode(
                        ...
                        true));
        $this->accounts_adclients = new AccountsAdclientsServiceResource($this,
                $this->serviceName, 'adclients',
                json_decode(
                        '{"methods": {"list": {"scopes": ["https://www.googleapis.com/auth/adsense", "https://www.googleapis.com/auth/adsense.readonly"], "parameters": {"pageToken": {"type": "string", "location": "query"}, "maxResults": {"format": "int32", "maximum": "10000", "minimum": "0", "location": "query", "type": "integer"}, "accountId": {"required": true, "type": "string", "location": "path"}}, "id": "adsense.accounts.adclients.list", "httpMethod": "GET", "path": "accounts/{accountId}/adclients", "response": {"$ref": "AdClients"}}}}',
                        true));
        $this->accounts_reports = new AccountsReportsServiceResource($this,
                $this->serviceName, 'reports',
                json_decode(
                        '{"methods": {"generate": {"scopes": ["https://www.googleapis.com/auth/adsense", "https://www.googleapis.com/auth/adsense.readonly"], "parameters": {"sort": {"repeated": true, "type": "string", "location": "query"}, "startDate": {"required": true, "type": "string", "location": "query"}, "endDate": {"required": true, "type": "string", "location": "query"}, "locale": {"type": "string", "location": "query"}, "metric": {"repeated": true, "type": "string", "location": "query"}, "maxResults": {"format": "int32", "maximum": "50000", "minimum": "0", "location": "query", "type": "integer"}, "filter": {"repeated": true, "type": "string", "location": "query"}, "currency": {"type": "string", "location": "query"}, "startIndex": {"format": "int32", "maximum": "5000", "minimum": "0", "location": "query", "type": "integer"}, "dimension": {"repeated": true, "type": "string", "location": "query"}, "accountId": {"type": "string", "location": "path"}}, "id": "adsense.accounts.reports.generate", "httpMethod": "GET", "path": "accounts/{accountId}/reports", "response": {"$ref": "AdsenseReportsGenerateResponse"}}}}',
                        true));
        ...
        $this->accounts_customchannels_adunits = new AccountsCustomchannelsAdunitsServiceResource(
                ...
                json_decode(
                        ...
                        true));
        $this->customchannels = new CustomchannelsServiceResource($this,
                $this->serviceName, 'customchannels',
                json_decode(
                        ...
                        true));
        $this->customchannels_adunits = new CustomchannelsAdunitsServiceResource(
                $this, $this->serviceName, 'adunits',
                json_decode(
...
class AdsenseReportsGenerateResponse extends apiModel
{
    ...
    {
        $this->assertIsArray($headers, 'AdsenseReportsGenerateResponseHeaders',
                __METHOD__);
